...
var _delay = __webpack_require__(/*! ./src/delay */ "./src/delay.js");
/**
 *
 * @module index
 */
...
module.exports = {
  defer: __webpack_require__(/*! ./src/defer */ "./src/defer.js"),
  delay: function delay(time) {
    return function (value) {
      return _delay(time, value);
    };
  },
  rolloff: __webpack_require__(/*! ./src/retryUntil */ "./src/retryUntil.js")
};
...
var convert = __webpack_require__(/*! ./convert */ "./node_modules/lodash/fp/convert.js"),
    func = convert('defaults', __webpack_require__(/*! ../defaults */ "./node_modules/lodash/defaults.js"));
...
module.exports = function growIt(initial, bound, rate, decimals) {
  ...
  return function () {
    ...
    var n = initial + initial * rate;
    var base = n * mult;
    var adj = Math.floor(base);
    initial = adj / mult;
    return initial;
  };
};
...
var defaults = __webpack_require__(/*! lodash/fp/defaults */ "./node_modules/lodash/fp/defaults.js")({
  timeout: 250,
  bound: 1000,
  growth: 0.2,
  tries: 10,
...
var isString = __webpack_require__(/*! lodash/fp/isString */ "./node_modules/lodash/fp/isString.js");
var isNumber = __webpack_require__(/*! lodash/fp/isNumber */ "./node_modules/lodash/fp/isNumber.js");
var isObject = __webpack_require__(/*! lodash/fp/isObject */ "./node_modules/lodash/fp/isObject.js");
var isFunction = __webpack_require__(/*! lodash/fp/isFunction */ "./node_modules/lodash/fp/isFunction.js");

var delay = __webpack_require__(/*! ./delay */ "./src/delay.js");
var growIt = __webpack_require__(/*! ./growIt */ "./src/growIt.js");
var limitArray = __webpack_require__(/*! ./utilities */ "./src/utilities.js").limitArray;
/**
...
module.exports = function retryUntil(func, config) {
  return function (value) {
    ...
    var timeoutGrowth = growIt(startingConfig.timeout, startingConfig.bound, startingConfig.growth, 2);
    ...
    function rolloff(c) {
      return new Promise(function (resolve, reject) {
        if (c.tries > 0) {
          ...
          Promise.resolve(promiseOrValue).then(function (result) {
            if (result) {
              return resolve(result);
            }
            return delay(newOpts.timeout, 10).then(function () {
          ...
          var e = new Error('Exhausted attempts.');
          e.errors = errors;
          reject(e);
        }
      });
...
module.exports = {
   ...
   */
  limitArray: function limitArray(array, item, limit) {
    var length = void 0;
...
//# sourceMappingURL=async-is-fun.js.map